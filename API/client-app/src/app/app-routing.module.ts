...
const routes: Routes = [
  ...
  {
    path: 'purchase-orders', canActivate: [AuthGuard],
    loadChildren: () => import('./purchase-order/purchase-order.module').then(m => m.PurchaseOrderModule)
  },
  {
    path: 'purchase-item', canActivate: [AuthGuard],
    loadChildren: () => import('./purchase-item/purchase-item.module').then(m => m.PurchaseItemModule)
  },

  {
    path: 'purchase-part', canActivate: [AuthGuard],
    loadChildren: () => import('./purchase-part/purchase-part.module').then(m => m.PurchasePartModule)
  },
